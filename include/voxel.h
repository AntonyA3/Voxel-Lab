...
void voxel_delete_voxel(Voxel **voxel, int shape, void *shapeData, int *changed);
void voxel_add_voxel(Voxel *voxel, int shape, void *shapeData, int *changed);
